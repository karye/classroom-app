...
function App() {
  ...
  const getGradeColorByPercent = (percent) => {
      ...
      if (percent < 50) return '#ffccc7'; // 0-49% (Ej godkänt)
      if (percent < 70) return '#d9f7be'; // 50-69% (Godkänt)
      if (percent < 90) return '#95de64'; // 70-89% (Bra)
      return '#52c41a'; // 90-100% (Utmärkt)
  }

  const calculateStudentPerformanceScore = (studentId, submissions, coursework) => {
      // Count failed assignments (< 50%)
  ...
  const getSortedStudents = (students, courseId, submissions, coursework) => {
      ...
      switch (sortType) {
          ...
          case 'perf-struggle': 
              return sorted.sort((a, b) => calculateStudentPerformanceScore(b.userId, submissions, coursework) - calculateStudentPerformanceScore(a.userId, submissions, coursework));
          case 'perf-top': 
              return sorted.sort((a, b) => calculateStudentPerformanceScore(a.userId, submissions, coursework) - calculateStudentPerformanceScore(b.userId, submissions, coursework));
          case 'name-asc':
          default:
  ...
  if (details) {
       ...
       // Sort topics alphabetically (e.g., K0, K1, K2...)
       ...
       sortedStudents = getSortedStudents(details.students, selectedCourseId, details.submissions, details.coursework);
  }
                                            ...
                                            ELEV
                                                                                ...
                                                                                {groupedWork.map(group => {
                                                                                    ...
                                                                                    <th 
                                                                                        ...
                                                                                        className="sticky-header-topic text-center cursor-pointer user-select-none px-1"
                                                                                        style={{ cursor: 'pointer', maxWidth: isExpanded ? 'none' : '50px' }}
                                                                                        title={`Klicka för att visa/dölja: ${group.name}`}
                                                                                    >
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                {groupedWork.map(group => {
                                                                                    ...
                                                                                    <React.Fragment key={group.id}>
                                                                                                                                        ...
                                                                                                                                        <th className="sticky-header-assign text-center bg-white" style={{ 
                                                                                                                    ...
                                                                                                                    >
                                                                                                                        ...
                                                                                                                        {groupedWork.map(group => {
                                                                                                                            ...
                                                                                                                            const cells = group.assignments.map((cw, idx) => {
                                                                                                                                ...
                                                                                                                                const cellBg = gradeColor === 'inherit' ? '#f8f9fa' : gradeColor;
                                                                                                                            ...
                                                                                                                            return (
                                                                                                                                <React.Fragment key={group.id}>
                                                                                                                                    ...
                                                                                                                                    <td className="text-center fw-bold align-middle" style={{ 
                                                                                                                                        ...
                                                                                                                                        color: maxGradePercent >= 90 ? 'white' : 'inherit',
                                                                                                                                        fontSize: '0.75rem'
                                                                                                                                    }}>
                                                                                                                                        {hasGrade ? maxGrade : '-'}
                                                                                                                                    </td>
